...
type Module =
  typeof import('../($locale).$shopid.orders.$token.authenticate.js');

type Info = GetInfo<{
  file: 'routes/($locale).$shopid.orders.$token.authenticate.tsx';
  module: Module;
}>;
...
type Matches = [
  ...
  },
  {
    ...
    module: typeof import('../($locale).$shopid.orders.$token.authenticate.js');
  },
];
