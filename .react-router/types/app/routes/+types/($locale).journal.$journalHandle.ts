...
type Module = typeof import('../($locale).journal.$journalHandle.js');

type Info = GetInfo<{
  file: 'routes/($locale).journal.$journalHandle.tsx';
  module: Module;
}>;
...
type Matches = [
  ...
  },
  {
    ...
    module: typeof import('../($locale).journal.$journalHandle.js');
  },
];
