...
type Module = typeof import('../($locale).collections.$collectionHandle.js');

type Info = GetInfo<{
  file: 'routes/($locale).collections.$collectionHandle.tsx';
  module: Module;
}>;
...
type Matches = [
  ...
  },
  {
    ...
    module: typeof import('../($locale).collections.$collectionHandle.js');
  },
];
