...
type Module = typeof import('../($locale).policies.$policyHandle.js');

type Info = GetInfo<{
  file: 'routes/($locale).policies.$policyHandle.tsx';
  module: Module;
}>;
...
type Matches = [
  ...
  },
  {
    ...
    module: typeof import('../($locale).policies.$policyHandle.js');
  },
];
